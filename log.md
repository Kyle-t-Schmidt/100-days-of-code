...
**Today's Progress**: Today I continued the Machine learning course on Udemy. The topics were multiple regression and data validation methods.
...
### Day 52: December 15, 2020

**Today's Progress**: Today I continued working on the MySQL course on Udemy, finishing out the string functions portion.
...
**Today's Progress**: Today I worked on my article titles project a bit more. My target variable has a lot of zeros which leads me to think that a zero-inflation poisson or negative binomial model would be best but I am struggling to get a good fit with either model. I am next going to see if I can use some of the other features in the dataset to separate out the "true" zeros.
...
### Day 56: December 19, 2020

**Today's Progress**: Today I worked on prepping the articles data for my new approach to the dataset.
...
### Day 58: December 21, 2020

**Today's Progress**: Today I continued working articles project. I also spent some time going over my resume to  try and figure out why I can't get a Data Scientist interview.

**Thoughts:**: I am getting a bit discouraged that I can't seem to get an interview.
